...
%
\def\title{Attentive Interpretable Tabular Learning in Context of Drug Discovery}
%
%
...
%
\def\institute{Institute for Machine Learning}
%
%
...
%
\def\supervisor{Univ.-Prof. Dr. Sepp Hochreiter}
\newif\ifsupvismale
\supvismaletrue
%\supvismalefalse
%
...
% and enter the name.
%
\def\assist{Philipp Seidl, MSc \\ Johannes Schimunek, LAss}
%
% enter month year
% (the month when you brought it to the Prüfungs- und Anerkennungsservice)
%
\def\date{January 2022} %TODO
%
...
\unitlength 1cm
\sffamily
\begin{picture}(16.7,2)
\ifeng
 \put(11.5,0){\includegraphics[width=5.2cm]{jku_en}}
\else
 \put(11.5,0){\includegraphics[width=5.2cm]{jku_de}}
\fi
\put(11.9,-1.7){\begin{minipage}[t]{8cm}\footnotesize%
\ifeng
 Submitted by\\
\else
 Eingereicht von\\
...
\date
\end{minipage}}
\put(12.9,-21){\begin{minipage}[t]{3.9cm}\footnotesize%
